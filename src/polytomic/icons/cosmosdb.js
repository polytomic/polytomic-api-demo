    ...
    return (
        <SvgIcon fill="none" viewBox="0 0 18 18" {...props}>
            ...
            <path
                ...
                fill="url(#cosmos-a)"
            />
            <g clipPath="url(#cosmos-b)" fill="#f2f2f2">
